...
<body class="fixed-left">
 ...
 <div id="wrapper">
   <div class="topbar" style="background: ;">
    <div class="topbar-left col-md-2 col-xs-2" style="padding-left:">
        <div class="text-center side-logo"> 
        <c:choose>
        	<c:when test="${is_updated==true}">
        	 <a class='logo' href="mobileHomePage"><img src="${logoTopIMG}" /></a>
        <a class='logo1' href=mobileHomePage><img src="${logoTopIMG1}" /></a>
        	</c:when>
        	<c:otherwise>
        	 <a class='logo' ><img src="${logoTopIMG}" /></a>
        <a class='logo1' style="margin-left: 15px;"><img src="${logoTopIMG1}" /></a>
        	</c:otherwise>
        </c:choose>
       </div>
    </div>
    <div class="navbar navbar-default col-md-10 col-xs-9" role="navigation">
             ...
             <div class="" style="padding-right:0">                
                <ul class="nav navbar-nav navbar-right pull-right">
                   <%--  <li class="dropdown hidden-xs">
                    ...
                    <li class="dropdown">
                        <a href="" class="dropdown-toggle profile waves-effect waves-light" data-toggle="dropdown" aria-expanded="true" style="margin-right: ;padding:0">
                             <%-- <c:choose>
			                 ...
			                 <i class="fa fa-user" aria-hidden="true" style="border: 1px solid #fff;border-radius: 50%; padding: 8px;"></i>
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li class="divider"></li>
                            <li><a href="mobilelogout"> Logout</a></li>
                        </ul>
                    </li>
                </ul>
             </div>
