...
<div class="breadcrumb">
	<h3>Client Validation Checklist</h3>					
	<a href="homePage">Home</a> » <a href="#">Client Validation Checklist</a>
</div>	
<div class="col-md-12">		
	...
	<div class = "borderForm filtertable" >
		<table id="table" 
			...
			<tr>
				...
				<th  data-field="Checklist Name" data-filter-control="input" data-sortable="true" >Checklist Name</th>
			...
			<c:forEach var = "list" items = "${checklist}">
				<tr>
					<td class='test' style="text-align: left;"  >
						<a href = "#" onclick = "viewChecklist('${list.checklist_id}')"><img src='${viewImg}' style = "width: 20px;"/></a>
						<a href = "#" onclick = "editChecklist('${list.checklist_id}')"><img src='${editImg}' style = "width: 20px;"/></a>
					
						</td>				
					<td style="text-align: left;">${list.checklist_name}</td>
					<td style="text-align: left;">${list.status==true ? "Active" : "Inactive"}</td>					
				</tr>
			</c:forEach>
			</tbody>
		</table>
