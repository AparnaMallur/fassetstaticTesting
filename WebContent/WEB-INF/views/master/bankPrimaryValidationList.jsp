...
<div class="breadcrumb">
	<h3>Bank Primary Validation</h3>
	<a href="homePage">Home</a> » <a href="#">Bank Primary Validation</a>
</div>	
<div class="col-md-12">		
...
$(function() {		
	...
	function viewBank(id){
		window.location.assign('<c:url value="viewBank"/>?id='+id+'&flag='+2);
	}
	...
	function approveBank(id){
		window.location.assign('<c:url value="approveBank"/>?id='+id + "&primaryApproval="+true);
	}
	
	function rejectBank(id){
		if (confirm("Are you sure you want to Reject record?") == true) {
			window.location.assign('<c:url value="rejectBank"/>?id='+id + "&rejectApproval="+true);
		    } 
	}
