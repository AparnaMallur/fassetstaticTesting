...
<div class="breadcrumb">
	<h3>Customer Primary Validation</h3>					
	<a href="homePage">Home</a> » <a href="#">Customer Primary Validation</a>
</div>	
<div class="col-md-12" >
...
$(function() {		
	...
	function viewCustomer(id){
		window.location.assign('<c:url value="viewCustomer"/>?id='+id+'&flag='+2);
	}
	...
	function approveCustomer(id){
		window.location.assign('<c:url value="approveCustomer"/>?id='+id+"&primaryApproval="+true);
	}
	
	function rejectCustomer(id){
		if (confirm("Are you sure you want to Reject record?") == true) {
			window.location.assign('<c:url value="rejectCustomer"/>?id='+id+"&rejectApproval="+true);
		    } 
	}
