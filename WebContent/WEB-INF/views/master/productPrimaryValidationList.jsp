...
<div class="breadcrumb">
	<h3>Product Primary Validation</h3>
	<a href="homePage">Home</a> » <a href="#">Product Primary Validation</a>
</div>	
<div class="col-md-12" >	
...
$(function() {		
	...
	function viewProduct(id){
		window.location.assign('<c:url value="viewProduct"/>?id='+id+'&flag='+2);
	}
	...
	function approveProduct(id){
		window.location.assign('<c:url value="approveProduct"/>?id='+id+"&primaryApproval="+true);
	}
	
	function rejectProduct(id){
		if (confirm("Are you sure you want to Reject record?") == true) {
			window.location.assign('<c:url value="rejectProduct"/>?id='+id+"&rejectApproval="+true);
		    } 
	}
