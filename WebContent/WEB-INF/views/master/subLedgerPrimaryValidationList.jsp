...
<div class="breadcrumb">
	<h3>Sub Ledger Primary Validation</h3>					
	<a href="homePage">Home</a> » <a href="#">Sub Ledger Primary Validation</a>
</div>	
<div class="col-md-12" >
...
$(function() {		
	...
	function viewSubLedger(id){
		window.location.assign('<c:url value="viewSubLedger"/>?id='+id+'&flag='+2);
	}
	...
	function approveSubLedger(id){
		window.location.assign('<c:url value="approveSubLedger"/>?id='+id + "&primaryApproval="+true);
	}
	
	function rejectSubLedger(id){
		if (confirm("Are you sure you want to Reject record?") == true) {
			window.location.assign('<c:url value="rejectSubLedger"/>?id='+ id + "&rejectApproval="+true);
		    } 
	}
