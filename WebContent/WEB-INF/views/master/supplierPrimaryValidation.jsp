...
<div class="breadcrumb">
	<h3>Supplier Primary Validation</h3>					
	<a href="homePage">Home</a> » <a href="#">Supplier Primary Validation</a>
</div>	
...
$(function() {		
	...
	function viewSupplier(id){
		window.location.assign('<c:url value="viewSupplier"/>?id='+id+'&flag='+2);
	}
	...
	function approveSupplier(id){
		window.location.assign('<c:url value="approveSupplier"/>?id='+id+"&primaryApproval="+true);
	}
	
	function rejectSupplier(id){
		if (confirm("Are you sure you want to Reject record?") == true) {
			window.location.assign('<c:url value="rejectSupplier"/>?id='+id+"&rejectApproval="+true);
		    } 
	}
