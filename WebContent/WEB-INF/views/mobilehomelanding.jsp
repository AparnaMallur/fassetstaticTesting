...
#mobileapp{position: absolute;top: 25%;    padding: 15px;}
...
#mobileapp .panel{width:100%;}
</style>
<!-- MOBILE UI FOR LOGIN -->
<div class="bg-mobile">
<div class="" id="mobileapp">
 	<div class="">
        <div class="panel panel-color panel-primary panel-pages">        
            <div class="panel-body">
		<c:if test="${error != null}">
                    ...
                    <div class="form-group">
                        <div class="col-xs-12">
                              <c:choose>
                                ...
                                <input class="form-control" name="isMobile" id="isMobile" value="1" type="hidden" >
		                    <c:if test="${nopasswd != null}">
								<span class="logError">${nopasswd}</span>
							</c:if>                        
						</div>
