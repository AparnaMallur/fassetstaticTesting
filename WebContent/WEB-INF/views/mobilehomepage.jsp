...
#wrapper #mobileview .panel .panel-heading{padding: 25px 10px;}
#wrapper #mobileview .panel .text-muted{color:#fff;font-size: 26px;line-height: 1.1;}
			...
			<div class="row">
					...
					<div class="panel text-center dashboard-panel1">
						<div class="panel-heading">
							<h4 class="panel-title text-muted font-light">
							 ...
							 <a href="salesEntryList">Sales<br/> Entry</a> 
							</h4>
						</div>
					</div>
				</div>
				...
				<div class="col-lg-3 col-md-3 col-sm-3 col-xs-6">
					<div class="panel text-center dashboard-panel2">
						<div class="panel-heading">
							<h4 class="panel-title text-muted font-light">
							<!-- <a href="receiptList">Receipt Voucher</a> -->
				...
				<div class="col-lg-3 col-md-3 col-sm-3 col-xs-6">
					<div class="panel text-center dashboard-panel3">
						<div class="panel-heading">
							<h4 class="panel-title text-muted font-light">
								<!-- <a href="purchaseEntryList"> 	Purchase Entry 	</a> -->
				...
				<div class="col-lg-3 col-md-3 col-sm-3 col-xs-6">
					<div class="panel text-center dashboard-panel4" >
						<div class="panel-heading">
							<h4 class="panel-title text-muted font-light">
								<!-- <a href="paymentList">Payment Voucher </a> -->
