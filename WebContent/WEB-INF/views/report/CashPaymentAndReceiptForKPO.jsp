...
<div class="col-md-12 wideform">
	<div class="fassetForm">
		<form:form id="cashPaymentandReceiptForm"
			action="exceptionReport1ForKPO" method="post" commandName="form" onsubmit="return checkdata();">
			<div class="row">
...
<script type="text/javascript">
	...
	function isValidDate(dateStr) {cashPaymentandReceiptForm
