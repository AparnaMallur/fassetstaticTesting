...
<div class="breadcrumb">
	...
	<a href="homePage">Home</a> » <a href="#">Activity Log</a>
</div>
<div class="col-md-12 wideform">
	<div class="fassetForm">
		<form:form id="activityLogReportForm"
			action="activityLogReport" method="post" commandName="form" onsubmit="return checkdata();">
			<div class="row">
			...
			<c:if test="${(role == '2' || role == '4')}">
			 ...
			 <div class="row">
				<div class="col-md-2 control-label">
					<label>Executive/Manager<span>*</span></label>
				</div>
				<div class="col-md-10">
					<form:select path="userId" class="logInput" id="userId">
						<form:option value="0" label="Executive/Manager" />
						<c:forEach var="user" items="${kpoList}">
							<form:option value="${user.user_id}">${user.first_name}${user.last_name}</form:option>
						</c:forEach>
					</form:select>
					<span class="logError"><form:errors path="userId" /></span>
				</div>
			</div>
...
<script type="text/javascript">
	...
	function checkdata(){
		...
		if(frmDate=="")
		   ...
		   {
			alert("Please Select Executive/Manager");
			return false;
		    }
			else if(date1 > date2)
			{				
