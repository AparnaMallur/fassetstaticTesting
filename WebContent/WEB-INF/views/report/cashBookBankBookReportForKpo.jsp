...
<div class="col-md-12 wideform">
	<div class="fassetForm">
		<form:form id="cashBookBankBookReportForKpoForm" action="cashBookBankBookReportForKpo" method="post" commandName="form" onsubmit="return checkdata();">
			<div class="row">
			...
			<div class="row">
				...
				<div class="col-md-10">
					<input type="text" style="color: black;" id="tDate"
						name="tDate" onchange="setDate1(this)" placeholder="To date" autocomplete="off">
			...
			<div class="row">
				...
				<div class="col-md-10">
					<form:select path="companyId" class="logInput" id="companyId"
						placeholder="Company Name" onChange= "getBankList(this.value)">
...
<script>
	...
	function getBankList(companyId){
		var bankArray = [];
	        	...
	        	console.log("User Name==="+data);
	        	 ...
	        	 $.each(data, function (index, bank) {
	        		 ...
	        		 var tempArray = [];
					    ...
					    tempArray["BankAcc"]=bank.account_no;
					    bankArray.push(tempArray);  
	                        // alert("Bank acc is "+BankAcc);
	             });
