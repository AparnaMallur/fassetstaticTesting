...
<div class="breadcrumb">
	...
	<a href="homePage">Home</a> » <a href="#">Cash Flow Summary</a>
</div>
<div class="col-md-12 wideform">
	<div class="fassetForm">
		<form:form id="cashFlowSummaryForm1" action="cashFlowSummaryReport" method="post" commandName="cashFlowSummaryForm" onsubmit="return checkdata();">
			<div class="row">
...
<script type="text/javascript">
	$(function() {
		$( "#frmDate" ).datepicker();
		$( "#toDate" ).datepicker();
		  <c:if test="${cashFlowSummaryForm.groupId != null && cashFlowSummaryForm.groupId > 0}">
			var groupID = <c:out value = "${cashFlowSummaryForm.groupId}"/>;
			if(groupID > 0){
				getList(groupID);
			}
		 </c:if>
