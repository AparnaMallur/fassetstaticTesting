...
<div class="col-md-12 wideform">
	<div class="fassetForm">
		<form:form id="cashFlowSummaryReportForm"
			action="cashFlowSummaryReportForKpo" method="post" commandName="form" onsubmit="return checkdata();">	
...
<script>
	$(function() {
			...
			<c:if test="${form.groupId != null && form.groupId > 0}">
				var gID = <c:out value = "${form.groupId}"/>;
				if(gID > 0){
					getList(gID);
				}
			 </c:if>
