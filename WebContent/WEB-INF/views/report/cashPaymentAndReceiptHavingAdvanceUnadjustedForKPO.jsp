...
<div class="col-md-12 wideform">
	<div class="fassetForm">
		<form:form id="cashPaymentAndReceiptHavingUnadjusedForm"
			action="exceptionReport3ForKPO" method="post" commandName="form" onsubmit="return checkdata();">
			<div class="row">
			...
			<div class="row">
				...
				<div class="col-md-10">
					<input type="text" style="color: black;" id="frmDate"
						name="frmDate" onchange="setDate(this)" placeholder="Report date " autocomplete="off">
