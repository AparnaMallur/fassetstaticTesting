...
<div class="breadcrumb">
	<h3>Horizontal Profit And Loss Report</h3>
	<a href="homePage">Home</a> » <a href="profitAndLossReport">Horizontal Profit And Loss Report</a>
</div>
<div class="col-md-12">
			...
			<c:if test="${ledgerform3!=null}">
				...
				<c:if test="${ledgerform3.subgroupName==accSubGroup}">
					...
					<c:if
						test="${openiBalanceOfLedger!=0 || total_debitOfLedger!=0 || total_creditOfLedger!=0}">
						<%-- <tr class='n-style'>
<td style="text-align: left;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;${ledgerform3.ledgerName}lll</td>
              <td class="tright"><fmt:formatNumber type="number" minFractionDigits="2" maxFractionDigits="2" value="${openiBalanceOfLedger+total_debitOfLedger-total_creditOfLedger+100}"/></td>
              <td></td>
               </tr> --%>
					</c:if>
				</c:if>
...
<button class="fassetBtn" type="button" id='btnExport3' onclick = 'exportexcel("Horizontal Profit & Loss Report")'>
	Download as Excel
</button>
</c:if>
