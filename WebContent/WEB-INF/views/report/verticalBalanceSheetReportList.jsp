...
<div class="breadcrumb">
	<h3>Vertical Balance Sheet Report</h3>
	<a href="homePage">Home</a> » <a href="horizontalBalanceSheetReport">Vertical Balance Sheet Report</a>
</div>
<div class="col-md-12">
	...
	<div style="display:none" id="excel_report">
		...
		<table>
			<thead>
				<tr>
					<th style='text-align: center'>Sources of Funds</th>
				</tr>
			</thead>
			<tbody>
	...
	<table>
			<thead>
				<tr>
					<th style='text-align: center'>Application of Funds</th>
				</tr>
			</thead>
			<tbody>
			 <c:set var="AssetsAmount" value="0"/>				
				<tr>
					<td style='vertical-align:top'>
						<!-- Start of Assets  -->
						<table>
				...
				<c:forEach var="obalance" items="${subOpeningList}">
                    ...
                    <c:otherwise> 
				               ...
				               <c:set var="closingBalance" value="${(closingBalance)+(obalanceBeStartDate.totaldebit_balance-obalanceBeStartDate.totalcredit_balance)+(obalance.totaldebit_balance-obalance.totalcredit_balance)}" /> 
			                      ...
			                      <c:set var="total_credit_Subgroup_beforeStartDate" value="${total_credit_Subgroup_beforerowcountStartDate + ledgerform1.ledgercredit_balance}" />
			                      <c:set var="total_debit_Subgroup_beforeStartDate" value="${total_debit_Subgroup_beforeStartDate + ledgerform1.ledgerdebit_balance}" />
			                        </c:if>
				                   </c:forEach>
				                    </c:if>
		...
		<c:if test="${rowcount == 0}">
			...
			<table id="Hiddentable">
				...
				<tr>
					<td></td>
					<td></td>
					<td style="color: blue; margin-left: 50px;">Vertical Balance Sheet Report
					</td>
				</tr>
	       ...
	       <c:if test="${subOpeningList.size()>0}">
				...
				<tr>
					...
					<td class="tright"><b><fmt:formatNumber type="number"
								...
								value="${TotalCreditAmount+totalNetProfit}" /></b></td>
				</tr>
			...
			<tbody>
				...
				<tr><th style='text-align: center'>Application of Funds</th></tr>
	...
	<c:if test="${role!=7}">
		...
		<button class="fassetBtn" type="button" id='btnExport3' onclick = 'exportexcel("Vertical Balance Sheet Report")'>
				Download as Excel
		</button>
		</c:if>
...
/* 	function pdf() {
		window.location.assign('<c:url value = "pdfVerticalBalanceSheetReport"/>');
	} */
</script>
