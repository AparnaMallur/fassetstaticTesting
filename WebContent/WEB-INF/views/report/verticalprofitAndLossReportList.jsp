...
<div class="breadcrumb">
	<h3>Vertical Profit And Loss Report</h3>
	<a href="homePage">Home</a> » <a href="profitAndLossReport">Vertical Profit And Loss Report</a>
</div>
<div class="col-md-12">
...
<div style="display:none" id="excel_report">
			...
			<thead>
				<tr>
					<th style='text-align: center'>Profit and loss account credit side</th>
				</tr>
			</thead>
			<tbody>
		...
		<table>
			<thead>
				<tr>
					<th style='text-align: center'>Profit and loss account debit side</th>
				</tr>
			</thead>
			<tbody>
	...
	<div class="table-scroll" style="display: none;" id="tableDiv">
		...
		<table id="Hiddentable">
			...
			<tr>
				<td></td>
				<td></td>
				<td style="color: blue; margin-left: 50px;">Vertical Profit And
					Loss Report</td>
			</tr>
			...
			<tr>
				<th style='text-align: center'>Profit and loss account credit
					side</th>
			</tr>
    	 ...
    	 <c:if test="${subOpeningList.size()>0}">
			...
			<!-- first table for credit side is closed -->

			<!-- Second table is started -->
			...
			<tbody>
				...
				<c:if test="${TotalDebitAmount>TotalCreditAmount}">
					<tr>
						...
						<td class="tright"><b><fmt:formatNumber type="number"
									...
									value="${TotalDebitAmount-TotalCreditAmount}" /></b> <c:set
								var="totalNetLoss"
								value="${totalNetLoss+(TotalDebitAmount-TotalCreditAmount)}" />
						</td>
					</tr>
				</c:if>
				<tr>
					...
					<td class="tright"><b><fmt:formatNumber type="number"
								minFractionDigits="2" maxFractionDigits="2"
								value="${TotalCreditAmount+totalNetLoss}" /></b></td>
				</tr>
				...
				<tr>
					<th style='text-align: center'>Profit and loss account debit
						side</th>
				</tr>
			...
			<c:if test="${TotalCreditAmount>TotalDebitAmount}">
				<tr>
					...
					<td class="tright"><b><fmt:formatNumber type="number"
								minFractionDigits="2" maxFractionDigits="2"
								value="${TotalCreditAmount-TotalDebitAmount}" /></b> <c:set
							var="totalNetProfit"
							value="${totalNetProfit+(TotalCreditAmount-TotalDebitAmount)}" />
					</td>
				</tr>
			</c:if>
			<tr>
				...
				<td class="tright"><b><fmt:formatNumber type="number"
							minFractionDigits="2" maxFractionDigits="2"
							value="${TotalDebitAmount+totalNetProfit}" /></b></td>
			</tr>
 ...
 --%>
	...
	<c:if test="${role!=7}">
		<button class="fassetBtn" type="button"
			...
			<button class="fassetBtn" type="button" id='btnExport3' onclick = 'exportexcel("Vertical Profit & Loss Report")'>
				Download as Excel
			</button>
	</c:if>
...
<script type="text/javascript">
	...
	/* function pdf() {
		window.location.assign('<c:url value = "pdfProfitAndLoss"/>');
	} */
</script>
