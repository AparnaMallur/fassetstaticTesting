...
<div class="breadcrumb">
	<h3>Edit Credit Note Product</h3>
	<a href="homePage">Home</a> » <a
		href="editCreditNote?id=${creditDetails.creditId}">Credit Note</a> » <a
		href="#">Edit Credit Note Product</a>

</div>
<div class="col-md-12 wideform">
	<div class="fassetForm">
		<form:form id="editProductForm" action="saveCreditDetails" method="post" commandName="creditDetails" onsubmit = "return validate();">
			<form:input path="credit_detail_id" id="credit_detail_id" type="hidden" />
			<form:input path="productId" id="productId" type="hidden" />
			<form:input path="transaction_amount" id="transaction_amount" type="hidden" />
			<form:input path="creditId" id="creditId" type="hidden" />
			<form:input path="is_gst" id="is_gst" hidden = "hidden"/>
			<input id="transaction_amount" value="${creditDetails.transaction_amount}" type="hidden" />
			<c:choose>
			
			<c:when test="${creditDetails.is_gst==2}">
							<!-- vat start -->
			...
			<c:otherwise>
			<c:choose>
				<c:when test="${customer.gst_applicable==true}">
					<c:choose>
						<c:when test="${compState != custState}">
			...
			<div class="row">
				...
				<div class="col-md-4">
					<input value="${creditDetails.product_id.product_name}"
				...
				<div class="col-md-4">
					<input value="${creditDetails.uom_id.unit}" disabled="disabled"
						style="width: 100%;" />
				</div>
			</div>
			...
			<div class="row">
				...
				<div  class="col-md-4">
					<input value="${creditDetails.product_id.hsn_san_no}"
						disabled="disabled" style="width: 100%;" />
				</div>
				<div class="col-md-2 control-label">
				...
				value="${creditDetails.quantity}" var="no_formattedquantity"/>	
			...
			<div class="row">
				...
				<div class="col-md-4">
				<fmt:formatNumber type="number" groupingUsed = "false"  minFractionDigits="2" maxFractionDigits="2" 
				value="${creditDetails.rate}" var="no_formattedRate"/>	
				...
				<div class="col-md-4">
				<fmt:formatNumber type="number" groupingUsed = "false"  minFractionDigits="2" maxFractionDigits="2" 
				value="${creditDetails.discount}" var="no_formattedDiscount"/>	
					<form:input path="discount" class="logInput" id="discount"
						placeholder="discount" onchange="calculaterate(this.value,3)"
						onkeypress="return isNumber(event)" value="${no_formattedDiscount}" maxlength="6" />
			...
			<div class="row">
				...
				<div class="col-md-4">
					<fmt:formatNumber type="number" groupingUsed = "false"  minFractionDigits="2" maxFractionDigits="2" 
				value="${creditDetails.labour_charges}" var="no_formattedlabour_charges"/>	
				...
				<div class="col-md-4">
				<fmt:formatNumber type="number" groupingUsed = "false"  minFractionDigits="2" maxFractionDigits="2" 
				value="${creditDetails.frieght}" var="no_formattedfrieght"/>	
			...
			<div class="row">
				...
				<div class="col-md-4">
				<fmt:formatNumber type="number" groupingUsed = "false"  minFractionDigits="2" maxFractionDigits="2" 
				value="${creditDetails.others}" var="no_formattedothers"/>	
				...
				<c:if test="${creditDetails.is_gst==2}">
				
				<div class="col-md-2 control-label"><label>VAT<span>*</span></label></div>		
				<div class="col-md-4">	
				<fmt:formatNumber type="number" groupingUsed = "false"  minFractionDigits="2" maxFractionDigits="2" 
				value="${creditDetails.labour_charges}" var="no_formattedlabour_charges"/>	
					<form:input path="VAT" class="logInput" id = "VAT" placeholder="VAT"  maxlength="20"/>
				...
				<div class="col-md-4">
				<fmt:formatNumber type="number" groupingUsed = "false"  minFractionDigits="2" maxFractionDigits="2" 
				value="${creditDetails.cgst}" var="no_formattedcgst"/>	
			...
			<c:choose>
				...
				<div class="col-md-4">	
				<fmt:formatNumber type="number" groupingUsed = "false"  minFractionDigits="2" maxFractionDigits="2" 
				value="${creditDetails.VATCST}" var="no_formattedVATCST"/>	
				...
				<div class="col-md-4">	
				<fmt:formatNumber type="number" groupingUsed = "false"  minFractionDigits="2" maxFractionDigits="2" 
				value="${creditDetails.excise}" var="no_formattedExcise"/>	
				...
				<div class="col-md-4">
					<fmt:formatNumber type="number" groupingUsed = "false"  minFractionDigits="2" maxFractionDigits="2" 
				value="${creditDetails.sgst}" var="no_formattedsgst"/>	
				...
				<div class="col-md-4">
					<fmt:formatNumber type="number" groupingUsed = "false"  minFractionDigits="2" maxFractionDigits="2" 
				value="${creditDetails.igst}" var="no_formattedigst"/>	
			...
			<div class="row">
				...
				<div class="col-md-4">
					<fmt:formatNumber type="number" groupingUsed = "false"  minFractionDigits="2" maxFractionDigits="2" 
				value="${creditDetails.state_com_tax}" var="no_formattedstate_com_tax"/>	
...
<script type="text/javascript">
	...
	function cancel() {
		var credit_id = "<c:out value= "${creditDetails.creditId}"/>";
		window.location.assign('<c:url value="editCreditNote"/>?id=' + credit_id);
