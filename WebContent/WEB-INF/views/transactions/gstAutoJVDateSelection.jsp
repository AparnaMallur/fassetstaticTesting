...
<div class="breadcrumb">
	<h3>GST Auto JV</h3>
	<a href="homePage">Home</a> » <a href="#">GST Auto JV</a>
</div>
<div class="col-md-12 wideform">
	<div class="fassetForm">
		<form:form id="purchaseReportForm"
			action="gstAutoJV" method="post" commandName="form"  onsubmit="return checkdata();">
			<div class="row">
			...
			<div class="row">
				...
				<div class="col-md-10">
					<input type="text" style="color: black;" id="transactionDate"
						name="transactionDate" onchange="setDate(this)" placeholder="Transaction Date" autocomplete="off">
						<span class="logError"><form:errors path="transactionDate" /></span>
				</div>
			</div>
...
<script type="text/javascript">
	...
	document.getElementById("transactionDate").value = e.value;
	// date format validation
	var datevali = document.getElementById("transactionDate").value;
if(isValidDate(datevali)==true){
	...
	function checkdata(){
		...
		if(transactionDate=="")
		{
		alert("Please Select From Report  Date");
		return false;
		}
		if(frmDate=="")
			{
