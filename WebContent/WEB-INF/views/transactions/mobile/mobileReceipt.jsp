...
.mobileReceiptForm .form-control, .mobileReceiptForm .form-control:focus{
     border: 0;
...
.mobileReceiptForm span.input-group-addon{
     border: 0;
     border-bottom: 1px solid #ccc;
     background-color: #fff;
     box-shadow: none;
...
<div class="col-md-12 mobileReceiptForm">
	<form:form id="receiptForm" action="saveReceipt" method="post" commandName="receipt" onsubmit="return checkamount();">
		<!-- Small modal -->
						...
						<c:forEach var="year" items="${yearList}">
							<c:choose>
								<c:when test="${first_year==0}">
									<form:radiobutton path="year_id" value="${year.year_id}" checked="checked"
										onclick="setdatelimit('${year.start_date}','${year.end_date}')" />
										${year.year_range} 
								</c:when>
								<c:otherwise>
		...
		<div class="fassetForm">
			...
			<form:input path="productInformationList" id="productInformationList" hidden="hidden" />
			...
			<div id="bill-tds" class="row" style="border: 1px; border-style: double; background: rgb(54, 94, 191); align-content:; color: white;">
				<div class="col-md-2">
			...
			<div class="row">
				<div class="col-xs-12">
					...
					<div class="form-group">
						<div class="input-group">
							<span class="input-group-addon"><img src='${billdateN}'	alt="Voucher" title="Voucher"></span> 
							<input type="text" style="color: black;" class="form-control" id="date" name="date" placeholder="Date" autocomplete="off" onchange="dateRestriction()" onclick="setDatePicker()" > 
					...
					<div id="customerInfo">
						<div class="form-group">
							<div class="input-group">
								<span class="input-group-addon"><img src='${usersN}' alt="Customer" title="Customer"></span> 
								<form:select path="customer_id" class="logInput form-control" id="customer_id" onChange="getList(this.value)">
									...
									<form:option value="-1" label="Income" />
								</form:select>
								<span class="logError"><form:errors path="customer_id" /></span>
							</div>
						</div>
						 
						<div class="form-group"  id="subledgerInfo">
							<div class="input-group">
								<span class="input-group-addon"><img src='${rupeeIndN}' alt="Income" title="Income"></span> 
								<form:select path="subledgerId" class="logInput form-control" placeholder="Income Type" id="subledger_id">
						...
						<div class="form-group"  id="customerbillInfo">
							<div class="input-group">
								<span class="input-group-addon"><img src='${shippingbillN}' alt="Customer Bill No" title="Customer Bill No"></span> 
								<form:select path="salesEntryId" class="logInput form-control" id="customer_bill_no">
					...
					<div class="form-group">
						<div class="input-group">
							<span class="input-group-addon"><img src='${notepadN}' alt="Receipt Type" title="Receipt Type"></span> 
					...
					<div class="form-group"  id="chequeDDNo">
						<div class="input-group">
							<span class="input-group-addon"><img src='${shippingbillN}' alt="Cheque / DD No / IB No / Transaction No" title="Cheque / DD No / IB No / Transaction No"></span> 
							<form:input path="cheque_no" class="logInput form-control" id="cheque_no" maxlength="${SIZE_HUNDRED}" placeholder="Cheque / DD No / IB No / Transaction No" />
					...
					<div class="form-group" id="chequeDate">
						<div class="input-group">
							...
							<form:input path="cheque_date" class="logInput form-control" id="cheque_date" placeholder="Cheque / DD Date / Transaction Date" autocomplete="off" />
					...
					<div class="form-group" id="chequeDate">
						<div class="input-group">
							...
							<form:select path="tds_paid" id="tds_paid" class="logInput form-control"	onChange="showTDSAmount(this.value)">
					...
					<div class="form-group" id="tds-amount">
						<div class="input-group">
							...
							<fmt:formatNumber type="number" groupingUsed = "false"  minFractionDigits="2" maxFractionDigits="2" value="${receipt.tds_amount}" var="tdsvalue"/>
							<form:input path="tds_amount" class="logInput form-control" id="tds_amount" placeholder="TDS Amount" value="${tdsvalue}"/>
					...
					<div class="form-group">
						<div class="input-group">
							<span class="input-group-addon"><img src='${notepadN}' alt="Advance Receipt" title="Advance Receipt"></span> 
							<form:select path="advance_payment" id="advance_payment" class="logInput form-control" onchange="setadvanceno(this.value)">
					...
					<div class="form-group">
						<div class="input-group">
							<span class="input-group-addon"><img src='${taxN}'	alt="TDS" title="TDS"></span> 
							<form:select path="gst_applied" id="gst_applied" onchange="showdetails(this.value)" class="logInput form-control">
					...
					<div class="form-group">
						<div class="input-group">
							...
							<fmt:formatNumber type="number" groupingUsed = "false"  minFractionDigits="2" maxFractionDigits="2" value="${receipt.amount}" var="amt"/>
							<form:input path="amount" class="logInput form-control" id="amount" maxlength="18" placeholder="Amount" value="${amt}" />
				...
				<table id='table-value' style="display: none">
					<tr>
						<td colspan="3">
							...
							<fmt:formatNumber type="number" groupingUsed = "false"  minFractionDigits="2" maxFractionDigits="2" value="${receipt.transaction_value}" var="trvalue"/>
							<form:input	path="transaction_value" class="logInput hlable" id="transaction_value" readonly="true"	style="background-color: transparent;" value="${trvalue}"/>
						</td>
						<td colspan="2">
							<label>CGST</label> 
							<fmt:formatNumber type="number" groupingUsed = "false"  minFractionDigits="2" maxFractionDigits="2" value="${receipt.cgst}" var="cgstvalue"/>
							<form:input path="cgst"	class="logInput hlable" id="cgst" readonly="true" style="background-color: transparent;" value="${cgstvalue}"/>
						</td>
						<td colspan="2">
							<label>SGST</label> 
							<fmt:formatNumber type="number" groupingUsed = "false"  minFractionDigits="2" maxFractionDigits="2" value="${receipt.sgst}" var="sgstvalue"/>
							<form:input path="sgst"	class="logInput hlable" id="sgst" readonly="true" style="background-color: transparent;" value="${sgstvalue}"/>
						</td>
						<td colspan="2">
							<label>IGST</label> 
							<fmt:formatNumber type="number" groupingUsed = "false"  minFractionDigits="2" maxFractionDigits="2" value="${receipt.igst}" var="igstvalue"/>
							<form:input path="igst"	class="logInput hlable" id="igst" readonly="true" style="background-color: transparent;" value="${igstvalue}"/>
						</td>
						<td colspan="2">
							<label>CESS</label>
							<fmt:formatNumber type="number" groupingUsed = "false"  minFractionDigits="2" maxFractionDigits="2" value="${receipt.state_compansation_tax}" var="cstvalue"/>
							<form:input path="state_compansation_tax" class="logInput hlable" id="state_compansation_tax" readonly="true" style="background-color: transparent;" value="${cstvalue}"/>
						</td>
						<td colspan="3">
							<label>Total Amount</label> 
							<fmt:formatNumber type="number" groupingUsed = "false"  minFractionDigits="2" maxFractionDigits="2" value="${receipt.round_off}" var="rndvalue"/>
							<form:input	path="round_off" class="logInput hlable" id="round_off"	readonly="true" style="background-color: transparent;" value="${rndvalue}"/>
						</td>
					</tr>
				</table>
			</div>
					...
					<table class="table table-bordered table-striped">
						...
						<tbody>
							<c:forEach var="prod_list" items="${customerproductList}">
								<tr>
									<td>
										<a href="#"	onclick="deleteproductdetail(${prod_list.receipt_detail_id})"><img src='${deleteImg}' style="width: 20px;" /></a> 
										<a href="#"	onclick="editproductdetail(${prod_list.receipt_detail_id})"><img src='${editImg}' style="width: 20px;" /></a>
									</td>
									<td>${prod_list.product_name}</td>
									<td>
										<fmt:formatNumber type="number" minFractionDigits="2" maxFractionDigits="2"	value="${prod_list.quantity}"/>
									</td>
									<td>${prod_list.UOM}</td>
									<td>${prod_list.HSNCode}</td>
									<td>
										<fmt:formatNumber type="number" minFractionDigits="2" maxFractionDigits="2"	value="${prod_list.rate}"/>
									</td>
									<td>
										<fmt:formatNumber type="number" minFractionDigits="2" maxFractionDigits="2"	value="${prod_list.discount}"/>
									</td>
									<td>
										<fmt:formatNumber type="number" minFractionDigits="2" maxFractionDigits="2"	value="${prod_list.labour_charges}"/>
									</td>
									<td>
										<fmt:formatNumber type="number" minFractionDigits="2" maxFractionDigits="2"	value="${prod_list.freight}"/>
									</td>
									<td>
										<fmt:formatNumber type="number" minFractionDigits="2" maxFractionDigits="2"	value="${prod_list.others}"/>
									</td>
									<td>
										<fmt:formatNumber type="number" minFractionDigits="2" maxFractionDigits="2"	value="${prod_list.CGST}"/>
									</td>
									<td>
										<fmt:formatNumber type="number" minFractionDigits="2" maxFractionDigits="2"	value="${prod_list.SGST}"/>
									</td>
									<td>
										<fmt:formatNumber type="number" minFractionDigits="2" maxFractionDigits="2"	value="${prod_list.IGST}"/>
									</td>
									<td>
										<fmt:formatNumber type="number" minFractionDigits="2" maxFractionDigits="2"	value="${prod_list.state_com_tax}"/>
									</td>
								</tr>
							</c:forEach>
						</tbody>
				...
				<table class="table table-bordered table-striped">
					...
					<tbody>
						<tr>
							...
							<td>
								<input class="logInput" id="HSNCode" placeholder="HSNCode" onchange="getHsnDetails(this.value)" maxlength="10" readonly />
							</td>
							<td>
								<input class="logInput" id="rate" placeholder="rate" onchange="calculaterate(this.value,2)"	onkeypress="return isNumber(event)" maxlength="12"/>
							</td>
							<td>
								<input class="logInput" id="discount" placeholder="Discount" onchange="calculaterate(this.value,3)"	onkeypress="return isNumber(event)" maxlength="6"/>
							</td>
							<td>
								<input class="logInput" id="labour_charges" placeholder="Labour charges" onchange="calculaterate(this.value,4)"	onkeypress="return isNumber(event)" maxlength="10"/>
							</td>
							<td>
								<input class="logInput" id="freight" placeholder="Freight charges" onchange="calculaterate(this.value,5)" onkeypress="return isNumber(event)" maxlength="10"/>
							</td>
							<td>
								<input class="logInput" id="others" placeholder="Other"	onchange="calculaterate(this.value,6)" onkeypress="return isNumber(event)" maxlength="10"/>
							</td>
							<td>
								<input id="CGST" class="logInput" placeholder="CGST" onkeypress="return isNumber(event)" maxlength="20"/>
							</td>
							<td>
								<input id="SGST" class="logInput" placeholder="SGST" onkeypress="return isNumber(event)" maxlength="20"/>
							</td>
							<td>
								<input id="IGST" class="logInput" placeholder="IGST" onkeypress="return isNumber(event)" maxlength="20"/>
							</td>
							<td>
								<input id="SCT" class="logInput" placeholder="CESS"	onkeypress="return isNumber(event)" maxlength="20"/>
							</td>
						</tr>
					</tbody>
				</table>
