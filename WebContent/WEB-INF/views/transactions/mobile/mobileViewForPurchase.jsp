...
.mobilePurchaseEntryForm span.input-group-addon {
    border: 0;
...
.mobilePurchaseEntryForm .form-control, .mobilePurchaseEntryForm .form-control:focus{
	border: 0;
...
<div class="col-md-12  mobilePurchaseEntryForm">	 
	<div class="">
				...
				<div class="col-md-12 col-xs-12">
					<div class="row">	
					 ...
					 <c:if test="${entry.purchase_id!=Null}"> 
		           	...
		           	<div class="form-group">	
						<div class="input-group">
							<span class="input-group-addon"><img src='${usersN}' alt="Customer" title="Supplier"></span> 
							<form:select path="supplier_id" class="logInput form-control" id="supplier_id" placeholder="Supplier Name"  onChange="getList(this.value)">
					...
					<div class="form-group">	
						<div class="info-sidebar col-md-6 col-sm-6 col-xs-12" style='display:none' id='info-sidebr' >
							<h4 class="m-b-30 m-t-0">Advance Payment</h4>
							<div class="info-data" id = "advancePayment" >
							</div> 
						</div>
						
						<div class="info-sidebar col-md-6 col-sm-6 col-xs-12" style='display:none' id='info-sidebr1' >
					...
					<div class="clearfix"></div>
			       	<div class="form-group">
						<div class="input-group">
							<span class="input-group-addon"><img src='${billdateN}' alt="supplier_bill_date" title="supplier bill date"></span> 
							<input type = "text" class="form-control" style = "color: black;" id = "supplier_bill_date" name = "supplier_bill_date"   placeholder = "Supplier bill date" autocomplete="off" onchange="dateRestriction()" onclick="setDatePicker()" />
							<span class="logError"><form:errors path="supplier_bill_date" /></span>
						</div>
					 </div>
					<div class="form-group">
						<div class="input-group">
							<span class="input-group-addon"><img src='${shippingbillN}' alt="supplier_bill_no" title="supplier bill no"></span> 
							<form:input path="supplier_bill_no" class="logInput form-control" id = "bill_no"  maxlength="20" placeholder="Supplier bill no" />
					...
					<div class="form-group">
						<div class="input-group">
							<span class="input-group-addon" style="border: 0 !important;"><img
								src='${rupeeIndN}' alt="Expense" title="Expense"></span> <input
								type="text" class="form-control" id="" name=""
								placeholder="Expense type*" style="border: 0;" readonly="readonly">
						</div>
						<div id="radio_home"></div>
						<span class="logError"><form:errors path="subledger_Id" /></span>
					</div>
					<div class="form-group">
						<div class="input-group">
							<span class="input-group-addon"><img src='${pencilN}' alt="Remark" title="Remark"></span>
							<form:textarea path="remark" class="logInput form-control" id = "remark" rows="3"  placeholder="Remark" maxlength="1000" ></form:textarea>
						</div>
					</div>
					<div class="form-group">
						<div class="input-group">
							<span class="input-group-addon"><img src='${notesN}' alt="Entry" title="Entry Type"></span> 
							<form:select path="entrytype" class="logInput form-control" id="entryType">
					...
					<div id = "exportDiv">
						<div class="form-group">
							<div class="input-group">
								<span class="input-group-addon"><img src='${shippingbillN}'	alt="Bill No." title="Shipping Bill No"></span>
								<form:input path="shipping_bill_no" class="logInput form-control" id = "shipping_bill_no" placeholder="Shipping Bill No" />
						...
						<div class="form-group">
						    <div class="input-group">
						       ...
						       <form:select path="export_type" class="logInput form-control" id="export_type">
						...
						<div class="form-group">
						    <div class="input-group">
						        ...
						        <input type = "text" style = "color: black;" class="form-control" id = "shipping_bill_date" name = "shipping_bill_date"   placeholder = "Shipping bill date" autocomplete="off" onchange="dateRestriction()" onclick="setDatePicker()" />	
						...
						<div class="form-group">
						    <div class="input-group">
						        ...
						        <form:input path="port_code" class="logInput form-control" id = "port_code" placeholder="Port Code" />
					...
					<div class="form-group" style="display:none" id="adv_voucher">
					    <div class="input-group">
					        <span class="input-group-addon"><img src='${shippingbillN}' alt="Payment No" title="Payment No"></span>
					        <div class="form-control" id="adv_voucher_no"></div>
					     
					    </div>
					</div>
					<div class="form-group" style="display:none" id="open_voucher">
					    <div class="input-group">
					        <span class="input-group-addon"><img src='${shippingbillN}' alt="Purchase against" title="Purchase against"></span>
					        <div class="form-control" id="open_voucher_no"></div>
					...
					<div id="total-amount-calc" style="display:none">
							...
							<div class="col-md-2">	
								<fmt:formatNumber type="number" minFractionDigits="2" maxFractionDigits="2"	value="${entry.transaction_value}"/> 					
									...
									<tr>
										...
										<c:choose>
											<c:when test="${prod_list.is_gst==2}">														
												<td>VAT</td>
												<td>
													<fmt:formatNumber type="number" minFractionDigits="2" maxFractionDigits="2" value="${prod_list.VAT}"/>
												</td>
												<td>
													<fmt:formatNumber type="number" minFractionDigits="2" maxFractionDigits="2" value="${prod_list.VATCST}"/>
												</td>
												<td>
													<fmt:formatNumber type="number" minFractionDigits="2" maxFractionDigits="2"	value="${prod_list.excise}"/>
												</td>
												<td>0</td>										
											</c:when>
											<c:otherwise>
