...
<div class="breadcrumb">
	<h3>Payment</h3>
	<a href="homePage">Home</a> » <a href="paymentList">Payment</a> » <a
		href="#">Create</a>
</div>
...
<%-- 				<form:input path="tds_amount" id = "tds_amount" type="hidden" />
 --%>				<form:input path="group" id="group" hidden="hidden" />
				<div class="col-md-6 col-xs-12">
					...
					<%-- 								<c:choose>
						<c:when test='${payment.payment_id==Null}'>
							<div class="row">				
					...
					<div class="row">
						...
						<div class="col-md-9">
							<form:input path="dateString" type="text" style="color: black;"
								id="paymentDate" placeholder="Date" autocomplete="off" onchange="dateRestriction()" onclick="setDatePicker()" />
					...
					<div class="row" id="supplierList">
						...
						<div class="col-md-9">
							<form:select path="supplierId" class="logInput" id='supplierId' onChange="setProduct(this.value)">
								...
								<form:option value="-1" label="Expenses/Assests/Liabilities" />
							</form:select>
							<span class="logError"><form:errors path="supplierId" /></span>
						</div>
					</div>
					<div class="row" id="subledgerList">
						<div class="col-md-3 control-label">
					...
					<div class="row" id="billNoList">
						<div class="col-md-3 control-label">
							<label>Supplier Bill No.<span>*</span></label>
						</div>
						<div class="col-md-9">
							<form:select path="purchaseEntryId" class="logInput" id="purchaseEntryId">
					...
					<div class="row">
						...
						<div class="col-md-9">
							<form:select path="payment_type" class="logInput" id='payment_type'>
								...
								<form:option
									value="<%=MyAbstractController.PAYMENT_TYPE_CASH %>">Cash</form:option>
								<form:option
									value="<%=MyAbstractController.PAYMENT_TYPE_CHEQUE %>">Cheque</form:option>
								<form:option value="<%=MyAbstractController.PAYMENT_TYPE_DD %>">DD</form:option>
								<form:option
									value="<%=MyAbstractController.PAYMENT_TYPE_NEFT %>">NEFT/RTGS/Net banking/Account Transfer</form:option>
					...
					<div class="row" id="chequeDDNo">
						<div class="col-md-3 control-label">
							<label>Cheque No./IB No.<span>*</span></label>
						</div>
						<div class="col-md-9">
							<form:input path="cheque_dd_no" class="logInput"
								id="cheque_dd_no" placeholder="Cheque No./IB No." />
					...
					<div class="row" id="chequeDate">
						...
						<div class="col-md-9">
							<form:input path="chequeDateString" type="text"
								style="color: black;" id="cheque_date" placeholder="Cheque Date" autocomplete="off"/>
							<span class="logError"><form:errors
									path="chequeDateString" /></span>
						</div>
					</div>
					<div class="row">
						<div class="col-md-3 control-label">
						...
						<div class="col-md-9">
						<fmt:formatNumber type="number" groupingUsed = "false"  minFractionDigits="2" maxFractionDigits="2" value="${payment.amount}"
				 var="amtvalue"/>
							<form:input path="amount" class="logInput" id="amount"
								placeholder="Amount Paid" value="${amtvalue}" 	maxlength="18"/>
					...
					<div class="row">
						...
						<div class="col-md-9">
						<form:select path="tds_paid" class="logInput"
...
<%-- 								<form:option value="0" label="--Select--" />
 --%>							
					...
					<div class="row" id="tds-amount">
						...
						<div class="col-md-9">
						<fmt:formatNumber type="number" groupingUsed = "false"  minFractionDigits="2" maxFractionDigits="2" value="${payment.tds_amount}"
				 var="tdsvalue"/>
							<form:input path="tds_amount" class="logInput"
								id="cheque_dd_no" placeholder="TDS Amount" value="${tdsvalue}"/>
				...
				<div class="col-md-6 col-xs-12">
					...
					<div class="row">
						<div class="col-md-3 control-label">
							<label>Advance Payment<span>*</span></label>
						</div>
						<div class="col-md-9">
							<form:select path="advance_payment" class="logInput" onchange="setadvanceno(this.value)">
								<form:option value="0" label="Select"/>									
								<form:option value="false">No</form:option>
								<form:option value="true">Yes</form:option>
							</form:select>
					...
					<div class="row" style="display:none;" >
						...
						<div class="col-md-9">
							<form:select path="gst_applied" class="logInput"
			...
			<table id='table-value' style="display:none">
				...
				<%-- 	<td colspan="2">
						...
						<form:input path="round_off" class="logInput hlable" id="round_off" readonly="true" style="background-color: transparent;" />
					</td> --%>
				</tr>
			</table>
