...
<div class="breadcrumb">
	...
	<a href="homePage">Home</a> » <a href="purchaseEntryList">Purchase Voucher</a> » <a href="#">View</a>
</div>
<div class="fassetForm">
		...
		<div class="tab-content">
		 ...
		 <div class="col-md-12"  style = "text-align: center; margin:15px;">
				<button class="fassetBtn" type="button" onclick = "DownloadPdf(${entry.purchase_id})"> 
			   Download As Pdf
		        </button>
		 </div>
			</div>
