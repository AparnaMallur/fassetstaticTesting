...
<div class="breadcrumb">
	<h3>Receipt</h3>
	<a href="homePage">Home</a> » <a href="receiptList">Receipt</a>
</div>
<div class="col-md-12">	
	<c:choose>
...
<div class="col-md-12 text-center">
		...
		<button  id="add" type="button" onclick = "checkImportReceipt()">
				Add New Receipt
		</button>
		</c:if>	
		...
		<button class="fassetBtn" type="button" onclick = "receiptFailure()">
					Failure List
		</button>
		</c:if> --%>
</div>
	...
	<div class = "borderForm" >
		<table id="table" 
			...
			<c:choose>
				  ...
				  <td style="text-align: left;">${receipt.voucher_no}${receipt.customer_id}</td>
                    <td style="text-align: left;"><fmt:parseDate value="${receipt.date}" pattern="yyyy-MM-dd" var="parsedDate" type="date"  />
                  ...
                  <td style="text-align: left;">
					     ...
					     <c:choose>
								<c:when test="${receipt.tds_paid==true}"><fmt:formatNumber type="number" minFractionDigits="2"
									maxFractionDigits="2" value="${receipt.amount+receipt.tds_amount}" />
									</c:when>
								<c:otherwise><fmt:formatNumber type="number" minFractionDigits="2"
									maxFractionDigits="2" value="${receipt.amount}" />
								   </c:otherwise>
					   </c:choose>
				    </td>
                    <td  style="text-align: left;">	
