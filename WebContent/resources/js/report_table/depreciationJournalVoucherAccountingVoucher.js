    ...
    $.fn.extend({
        tableExport: function (options) {
            var defaults = {
                ...
                fileName: 'DepreciationJournalVoucherAccountingVoucher_Report',
                htmlContent: false,
                ignoreColumn: [],
                ignoreRow:[],
            ...
            if (defaults.type == 'csv' || defaults.type == 'txt') {
                ...
                var $tables = $(el).filter(function() {
                    return $(this).data("tableexportDisplay") != 'none' &&
                        ($(this).is(':visible') ||
                        $(this).data("tableexportDisplay") == 'always');
                });
                var docData = '';
                    ...
                    $($rows).each(function() {
                        ...
                        ForEachVisibleCell(this, 'td,th', rowIndex, $hrows.length + $rows.length,
                            function(cell, row, col) {
                                if (cell !== null) {
                                    var tdstyle = '';
                                    var tdcss = $(cell).data("tableexportMsonumberformat");
                ...
                if ($.inArray(rowIndex, defaults.ignoreRow) == -1 &&
                    ...
                    var $row = $(tableRow).filter(function() {
                        return $(this).data("tableexportDisplay") != 'none' &&
                            ($(this).is(':visible') ||
                            $(this).data("tableexportDisplay") == 'always' ||
                            $(this).closest('table').data("tableexportDisplay") == 'always');
                    }).find(selector);
                    ...
                    $row.each(function (colIndex) {
                        if ($(this).data("tableexportDisplay") == 'always' ||
                            ($(this).css('display') != 'none' &&
                            $(this).css('visibility') != 'hidden' &&
                            $(this).data("tableexportDisplay") != 'none')) {
