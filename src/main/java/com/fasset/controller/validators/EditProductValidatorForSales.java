...
@Component
public class EditProductValidatorForSales extends MyValidator implements Validator{

	@Override
	public boolean supports(Class<?> clazz) {
		return SalesEntryProductEntityClass.class.equals(clazz);
	}

	@Override
	public void validate(Object target, Errors errors) {
		SalesEntryProductEntityClass salesproduct=(SalesEntryProductEntityClass) target;
		long is_gst=salesproduct.getIs_gst();
