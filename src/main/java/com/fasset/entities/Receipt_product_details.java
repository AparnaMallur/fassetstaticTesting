...
public class Receipt_product_details {
	...
	@Column(name="receipt_receipt_id",nullable = false)
	private  Long receipt_header_id;
	...
	public Long getReceipt_detail_id() {
		return receipt_detail_id;
	}

	public void setReceipt_detail_id(Long receipt_detail_id) {
		this.receipt_detail_id = receipt_detail_id;
	}

	public Long getReceipt_header_id() {
		return receipt_header_id;
	}

	public void setReceipt_header_id(Long receipt_header_id) {
		this.receipt_header_id = receipt_header_id;
	}
	...
	public String toString() {
		return "Receipt_product_details [product_name=" + product_name + ", quantity=" + quantity + ", rate=" + rate
				+ ", discount=" + discount + ", CGST=" + CGST + ", IGST=" + IGST + ", SGST=" + SGST + ", state_com_tax="
				+ state_com_tax + ", labour_charges=" + labour_charges + ", freight=" + freight + ", Others=" + Others
				+ ", UOM=" + UOM + ", HSNCode=" + HSNCode + ", transaction_amount=" + transaction_amount + "]";
	}
