 ...
 */
@Entity
@Table(name = "sales_Entry_product")
public class SalesEntryProductEntityClass {

	@Id
	@GeneratedValue
	@Column(name = "sales_detail_id", unique = true, nullable = false)
	private Long sales_detail_id;
	
	@Column(name = "products_product_id",nullable = false)
	private Long product_id ;
	
	@Column(name = "sales_Entry_sales_id",nullable = false)
	...
	public Long getSales_detail_id() {
		return sales_detail_id;
	}

	public void setSales_detail_id(Long sales_detail_id) {
