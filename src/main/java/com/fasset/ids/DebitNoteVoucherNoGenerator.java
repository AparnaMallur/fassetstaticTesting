...
public class DebitNoteVoucherNoGenerator implements IdentifierGenerator{
	...
	public Serializable generate(SessionImplementor session, Object object) throws HibernateException {
		...
		try {
			PreparedStatement pst = con.prepareStatement("select count(debit_no_id) as count from debit_note where created_date=?");
			pst.setDate(1, date);
