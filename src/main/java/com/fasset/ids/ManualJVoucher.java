 ...
 *
 */
public class ManualJVoucher implements IdentifierGenerator{
	...
	public Serializable generate(SessionImplementor session, Object object) throws HibernateException {	
		...
		try {
			PreparedStatement pst = con.prepareStatement("select count(journal_id) as count from journal_voucher where created_date=?");
			pst.setDate(1, date);
