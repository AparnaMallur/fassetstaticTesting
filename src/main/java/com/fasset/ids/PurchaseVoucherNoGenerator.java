...
public class PurchaseVoucherNoGenerator implements IdentifierGenerator{
	...
	public Serializable generate(SessionImplementor session, Object object) throws HibernateException {	
		...
		try {
			PreparedStatement pst = con.prepareStatement("select count(purchase_id) as count from purchase_Entry where created_date=?");
			pst.setDate(1, date);
