...
public class SalesVoucherNoGenerator implements IdentifierGenerator {
	...
	public Serializable generate(SessionImplementor session, Object object) throws HibernateException {
		...
		try {
			PreparedStatement pst = con.prepareStatement("select count(sales_id) as count from sales_Entry where created_date=?");
			pst.setDate(1, date);
