...
public class PDFBuilderForHorizontalProfitAndLoss extends AbstractITextPdfView{
	...
	protected void buildPdfDocument(Map<String, Object> model, Document document, PdfWriter writer,
		...
		response.setHeader("Content-Disposition", "attachment; filename=\"Horizontal Profit And Loss Report.pdf\"");
