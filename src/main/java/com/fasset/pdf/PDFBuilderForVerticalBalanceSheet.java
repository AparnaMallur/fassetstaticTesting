...
public class PDFBuilderForVerticalBalanceSheet extends AbstractITextPdfView{
	...
	protected void buildPdfDocument(Map<String, Object> model, Document document, PdfWriter writer,
		...
		response.setHeader("Content-Disposition", "attachment; filename=\"Vertical Balance Sheet Report.pdf\"");
		...
		Paragraph para = new Paragraph(new Phrase("Vertical Balance Sheet Report"));
		...
		if (subOpeningList.size() > 0) {
			...
			//mainTable.setWidths(new float[] { 5.0f, 5.0f });
			...
			PdfPCell header1 = new PdfPCell(new Phrase("Sources of Funds",boldFont));
			//header1.setVerticalAlignment(PdfPCell.ALIGN_CENTER);	
			...
			//cell.setVerticalAlignment(PdfCell.ALIGN_CENTER);
			...
			PdfPCell header2 = new PdfPCell(new Phrase("Application of Funds",boldFont));
			//header2.setVerticalAlignment(PdfPCell.ALIGN_CENTER);
			...
			cell.setPhrase(new Phrase("Sources of Funds", font));
			table.addCell(cell);

			cell.setPhrase(new Phrase("Application of Funds", font));
			table.addCell(cell);
